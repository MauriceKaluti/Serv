...
<head>
    ...
    <title>ResQ 247 | Event Tickets </title>
    <!-- Favicon-->
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            @forelse($tickets as $ticket)
                                    ...
                                    <a target="_blank" href="#"><i style="color: red;" class="fa fa-toggle-on"></i> Activate</a>
                                 

                                <a href="#')"><i style="color: red;" class="fa fa-toggle-off"></i> Deactivate</a>
                                </td>
                         
                                             <td><a href="#" onclick="return confirm('Do you really want to delete this Event?');" title="Delete Event Forever"> <i style="color: red;" class="fa fa-trash"></i></a>&nbsp&nbsp
                                             	<a href="{{url('/admin_area/add_event_images/'.$ticket->id)}}" title="Upload Partner Images"><i class="fa fa-upload"></i></a>
                                             </td>
                                        </tr>
