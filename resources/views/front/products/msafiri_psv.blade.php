...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 | Msafiri ResQ247 Product - PSV Package</title>
...
@include('layouts.header')
    ...
    <!-- bradcam_area_start  -->
    <div class="bradcam_area breadcam_bgMsafiri ">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Msafiri ResQ247 Product - PSV</h3>
                        <p><a href="{{url('/')}}">Home /</a> Msafiri ResQ247 Product - PSV</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title"> Msafiri ResQ247 Product - (PSV)</h2>

<p>Just like the name, Msafiri is a product meant for travelers both in private and public vehicles.
ResQ247 is dedicated to making our Roads safe and secure by providing support services on the
go.

</p>

<p>
It's traumatizing to see an accident victim gets subjected to more suffering when a medical facility turns them away in their time of need. This is a common phenomenon in Kenya. Having a partner who understands the industry and has products that do not only address the need but also takes care of your interests is key in making you rest easy knowing you have someone to turn to when that time comes. That is where ResQ247 comes in.

</p>

 <p>
   
For as low as Ksh. 130 per passengers in PSV and Ksh. 800 for private motorists - we get you covered for the entire trip.
<br><br><b style="color: black;">Benefits</b><br> 
<ul>
<li><i class="fa fa-circle"></i> &nbsp Access to Our SOS mobile Application.</li>
<li><i class="fa fa-circle"></i> &nbsp Passengers transfers in an event of an a major mechanical break down</li>
<li><i class="fa fa-circle"></i> &nbsp Evacuations from accident scenes accidents and hospital transfers</li>
<li><i class="fa fa-circle"></i> &nbsp Post-accident support & road accident rescue</li>
<li><i class="fa fa-circle"></i> &nbsp  Medical Bills settlement of up to;<br>
- Ksh. 150,000 for Inpatient<br>
- Ksh. 30,0000 for Out Patient
</li>
<li><i class="fa fa-circle"></i> &nbsp And much more. We got your back all the way to your destination!</li>
</ul>
</p>
 ...
 <form class="form-contact contact_form"  method="post">
     ...
     <div class="popup_boxPage ">
            <div class="popup_inner">
                <h3>Apply For PSV Cover</h3>
                            <div class="row">
 
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="sacco_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter SACCO Name'" placeholder="Enter SACCO Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="route_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Route Name'" placeholder="Enter Route Name">
                                    </div>
                                </div>
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="fleet_no"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Fleet No." placeholder="Enter Fleet No.">
                                    </div>
                                </div>
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="booking_office"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Booking Office Name'" placeholder="Enter Booking Office Name">
                                    </div>
                                </div>
                                ...
                                <div style="margin-bottom: 30px;" class="col-sm-6">
                                    <div class="form-group">
                                          <select required="" name="county" class="form-select wide" id="default-select" >
                                <option data-display="Select Your County">Your County</option>
                            ...
                            <div class="form-group">
                              <select name="town">
                               <option >Select Operation Town</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="booking_person"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Booking Person Name'" placeholder="Enter Booking Person Name">
                                    </div>
                                </div>
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="departure_time"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Departure Time'" placeholder="Enter Departure Time">
                                    </div>
                                </div>
                                   ...
                                   <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="vehicle_driver"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Driver Name'" placeholder="Enter Driver Name">
                                    </div>
                                </div>
          ...
          <div class="form-group">
                  ...
                  <label for="terms_agree">I agree to share details with ResQ247 in line with  <a href="privacy_policy.php">OUR ONLINE POLICY</a></label>
            </div>
                            <div class="form-group mt-3">
                                <button name="submitApp" type="submit" class="boxed-btn3-login">Apply Now</button>
                            </div>
                             </div>
                              </div>
