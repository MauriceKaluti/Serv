...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 | Dharura ResQ247 Product - Bronze Package</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <p><a href="index.php">Home /</a> Dharura ResQ247 Product - Bronze</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Dharura ResQ247 Product - Bronze Package</h2>
...
<ul>
<li><i class="fa fa-circle"></i> &nbsp Up to 30 Km free towing</li>
<li><i class="fa fa-circle"></i> &nbsp On-site minor mechanical repairs,</li>
<li><i class="fa fa-circle"></i> &nbsp Free tire puncture and replacement</li>
<li><i class="fa fa-circle"></i> &nbsp Post accident support</li>
<li><i class="fa fa-circle"></i> &nbsp Auto consultancy</li>
<li><i class="fa fa-circle"></i> &nbsp Free fire stop extinguisher</li>
<li><i class="fa fa-circle"></i> &nbsp 1 taxi service up to 20Km</li>

<li><i class="fa fa-circle"></i> &nbsp For as low as Ksh. 3,000 per year</li>
</ul>
</p>
        ...
        <div  class="col-12 col-lg-3 " data-wow-delay="100ms">
           <!--  <label >Silver Package</label> -->
               ...
               <div class="col-12 col-lg-3 " data-wow-delay="100ms">
                ...
                <input type="radio" checked="" name="bronze_package" class="form-control" placeholder="Bronze Package" required>
