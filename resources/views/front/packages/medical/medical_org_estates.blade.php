...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 | Organized Estates - ResQ247 Emergency Medical Packages</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Organized Estates - ResQ247 Medical Package</h3>
                        <p><a href="{{url('/')}}">Home /</a> Corporate - ResQ247 Medical Package</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Organized Residential Estates Membership - ResQ247 Emergency Medical Packages</h2>
...
<li><i class="fa fa-circle"></i> Free 1 DCP fire extinguisher per household</li>
...
<li><i class="fa fa-circle"></i> Free First Aid and fire safety training for appointed persons within the estate</li>
<li><i class="fa fa-circle"></i> Free standby ambulance for major events within the estate</li>
<li><i class="fa fa-circle"></i> No limit of persons within a household</li>
<li> Registration fees : From 8,500 per household per year</li>
</ul>
</p>
      ...
      <form class="form-contact contact_form"  method="post">
          ...
          <div class="popup_boxPage ">
            <div class="popup_inner">
             <h3>Subscribe For Emergency Medical Services For Organised Estates</h3>
                            <div class="row"> 

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="est_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Estate Name'" placeholder="Enter Estate Name">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="phone_one"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Tel'" placeholder="Enter Tel">
                                    </div>
                                </div>
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="phone_two" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Mobile Phone No'" placeholder="Enter Mobile Phone No">
                                    </div>
                                </div>
                      ...
                      <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="contact_person" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Contact Person Name'" placeholder="Enter Contact Person Name">
                                    </div>
                                </div>
                            ...
                            <div style="margin-bottom: 30px;" class="col-sm-6">
                                <div class="form-group">
                                <select required="" name="town" class="form-select wide" id="default-select" >
                               ...
                               <option value="Nairobi Metro">Nairobi Metro</option>
                                ...
                                <option value="Kendu Bay">Kendu Bay</option>
                                  ...
                                  <div style="margin-bottom: 30px;" class="col-sm-6">
                                <div class="form-group">
                                <select required="" name="no_households" class="form-select wide" id="default-select" >
                                <option data-display="Select Households Number">Select Households Number</option>
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="special_geographical"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Any Special Landmarks'" placeholder="Enter Special Landmarks">
                                    </div>
                                </div>
        ...
        <div class="form-group mt-3">
            <button name="submit5" type="submit" class="boxed-btn3-login">Subscribe Now</button>
        </div>
         </div>
          </div>
       </form>
