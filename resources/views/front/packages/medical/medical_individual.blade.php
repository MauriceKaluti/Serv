...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 | Individual - ResQ247 Medical Package</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Corporate - ResQ247 Individual Medical Package</h3>
                        <p><a href="{{url('/')}}">Home /</a> Corporate - ResQ247 Individual Medical Package</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Medical Membership - ResQ247 Individual Package</h2>
  ...
  <div class="card card-body">
            ...
            <div class="popup_inner">
                <h3>Subscribe For Emergency Medical Services For Individual</h3>
                            <div class="row">
 

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="ind_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'" placeholder="Enter Name">
                                    </div>
                                </div>
                            ...
                            <div style="margin-bottom: 30px;" class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="refer_facility"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Preferrable Medical Facility'" placeholder="Enter Preferrable Medical Facility">
                                    </div>
                                </div>

                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="facility_phone"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Facility Phone'" placeholder="Enter Facility Phone">
                                    </div>
                                </div>

                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="special_condition"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Any Medical Special Condition'" placeholder="Enter Any Medical Special Condition">
                                    </div>
                                </div>
                                   ...
                                   <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select required="" name="duration"  class="form-select wide" >
            ...
            <div class="form-group mt-3">
                <button name="submit3" type="submit" class="boxed-btn3-login">Subscribe Now</button>
            </div>
            </div>
            </div>
            </form>
