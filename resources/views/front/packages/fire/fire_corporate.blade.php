...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 | Corporate - ResQ247 Fire Package</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Corporate - ResQ247 Fire Package</h3>
                        <p><a href="{{url('/')}}">Home /</a> Corporate - ResQ247 Fire Package</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Corporate Membership - ResQ247 Fire Package</h2>
      ...
      <form class="form-contact contact_form"  method="post">
            ...
            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="org_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Organisation Name'" placeholder="Enter Organisation Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
           ...
           <div style="margin-bottom: 30px;" class="col-sm-6">
            ...
            <div class="form-group mt-3">
                <button name="submitApp1" type="submit" class="boxed-btn3-login">Apply Now</button>
            </div>
            </div>
            </div>
       </form>
