...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 | Hotel - ResQ247 Fire Package</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Hotel - ResQ247 Fire Package</h3>
                        <p><a href="{{url('/')}}">Home /</a> Hotel - ResQ247 Fire Package</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Hotel Membership - ResQ247 Fire Package</h2>
  ...
  <div class="card card-body">
         ...
         <form class="form-contact contact_form"  method="post">
            ...
            <div class="popup_inner">
                <h3 class="contact-title">Subscribe For Hotel Membership</h3>
                            <div class="row">
 

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="hotel_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Hotel Name'" placeholder="Enter Hotel Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="number_staffs" type="number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Number of Staff'" placeholder="Enter Number of Staff">
                                    </div>
                                </div>
                                ...
                                <option value="Kendu Bay">Kendu Bay</option>
                                      ...
                                      <div style="margin-bottom: 30px;" class="col-sm-6">
                                    <div class="form-group">
                                <select required="" name="serv_category" class="form-select wide" id="default-select" >
                                <option data-display="Select Your Service Category">Category</option>
                                <option value="Fire Inspection">Fire Inspection</option>
                                <option value="Fire Audit">Fire Audit</option>
                                <option value="Fire rescue and emergency medical rescue">Fire rescue and emergency medical rescue</option>
            ...
            <div class="form-group mt-3">
                <button name="submitApp5" type="submit" class="boxed-btn3-login">Subscribe Now</button>
            </div>
             </div>
              </div>
        </form>
