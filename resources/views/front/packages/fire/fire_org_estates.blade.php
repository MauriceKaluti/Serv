...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 |  Estates - ResQ247 Fire Package</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Estates - ResQ247 Fire Package</h3>
                        <p><a href="{{url('/')}}">Home /</a> Estates - ResQ247 Fire Package</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Estates Membership - ResQ247 Fire Package</h2>
     ...
     <form class="form-contact contact_form"  method="post">
         <div class="popup_boxPage ">
            <div class="popup_inner">
                <h3>Subscribe For Emergency Fire Services For Estates</h3>
                            <div class="row">
        ...
        <div class="form-group mt-3">
            <button name="submitApp3" type="submit" class="boxed-btn3-login">Subscribe Now</button>
        </div>
        </div>
        </div>
    </form>
