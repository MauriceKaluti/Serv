...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ResQ 247 |  Individual Private Residence - ResQ247 Fire Package</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Individual Private Residence - ResQ247 Fire Package</h3>
                        <p><a href="{{url('/')}}">Home /</a> Individual Private Residence - ResQ247 Fire Package</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="contact-title">Individual Private Residence Membership - ResQ247 Fire Package</h2>
  ...
  <div class="card card-body">
    ...
    <form class="form-contact contact_form"  method="post">
            ...
            <div class="popup_inner">
                <h3>Subscribe For Emergency Fire Services For Individual Private Residence</h3>
                            <div class="row">
 
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" class="form-control valid" name="res_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Residential Name'" placeholder="Enter Residential Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
        ...
        <div class="form-group mt-3">
            <button name="submitApp4" type="submit" class="boxed-btn3-login">Subscribe Now</button>
        </div>
        </div>
        </div>
    </form>
