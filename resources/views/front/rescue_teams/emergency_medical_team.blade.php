...
<head>
    ...
    <title>ResQ247 Services | Medical Rescue Team Sign Up</title>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="text-center">
                        ...
                        <h2 style="font-size: 70px; color: gold;"><strong>BECOME AN 
EMERGENCY MEDICAL RESCUER</strong></h2>
                        <p>Earn cash and help people near you by reponding to all medical emergency cases in your area</p>
                         <div class="info_button">
                           <!--  <a  href="#test-form"class="boxed-btn3-white popup-with-form">Sign Up As A Rescuer</a> -->

                             <a class="boxed-btn3-white" title="Sign Up As An EMS Rescuer" data-toggle="modal" data-target="#medicalTeamModal"  href="">Sign Up As An EMS Rescuer <i class="fa fa-hand-pointer-o"></i></a> 
                        </div>
                    </div>
                </div>
            </div>
  ...
  <ol class="breadcrumb">
    ...
    @endif
    <li class="breadcrumb-item active" aria-current="page">Medical Rescue Team </li>
  </ol>
</nav>
            <div  class="row">
                ...
                <div style=" background-color: #FFD700;" class="col-md-4 ">
                  <div class="text-center"> 
                    ...
                    <br><br>
                    <h2 style="color: #fff;"><strong>EARN EXTRA<br> CASH</strong></h2>
                  </div>
                    <p style="color: #fff; font-size: 20px;"><i style="color: #4169E1;" class="fa fa-circle"></i> Do you have a 24 hours operational medical facility? Do you have a BLS or ALS fully equipped and functional ambulance attached to your medical facility? </p> 
                    <p style="color: #fff; font-size: 20px;"> <i style="color: #4169E1;" class="fa fa-circle"></i> Can you have a paramedic team that can work around the clock? Then this is a perfect opportunity for your medical facility. Make some extra cash by responding to Medical Emergency rescues around your area!</p>
                </div>


                <div  style="background-color: #4169E1; " class="col-md-4">
                  <div class="text-center"> 
                   <i style="color: red; font-size: 40px; margin-top: 30px;" class="fa fa-bed"></i>
                   <br><br>
                   <h2 style="color: #fff;"><strong>HELP EMERGENCY VICTIMS</strong></h2>
                 </div>
                   ...
                   <p style="color: #fff; font-size: 20px;"><i style="color: #fff;" class="fa fa-circle"></i> Join the larger family of on demand paramedic service providers across the country. Nothing is fulfilling as having a life saved through your efforts.</p> 
                </div>
                ...
                <div style=" background-color: #FFD700;" class="col-md-4">
                  <div class="text-center"> 
                   ...
                   <br><br>
                   <h2 style="color: #fff; font-size: 30px;"><strong>BE YOUR OWN <br> BOSS</strong></h2>
                 </div>
...
<div class="container">
    ...
    <h2 align="left" class="contact-title" style="color: #0000fb;">A DAY IN THE LIFE OF A MEDICAL EMERGENCY RESCUER</h2>
    </div>
        ...
        <div class="card-header" id="signapp">
          <h5 class="mb-0">
            <button class="btn btn-link" data-toggle="collapse" data-target="#signA" aria-expanded="true" aria-controls="signA">
              <i class="fa fa-circle"></i> DOWNLOAD & SIGN IN TO THE EMS APP
            </button>
          </h5>
        </div>
...
<div class="container">
    ...
    <div class="col-md-12">
       ...
       <a class="boxed-btn3-login" title="Sign Up As An EMS Rescuer" data-toggle="modal" data-target="#medicalTeamModal"  href="">Sign Up As An EMS Rescuer <i class="fa fa-hand-pointer-o"></i></a> 
      </div>
        </div>
        </div>
    </div>
...
@include('layouts.selects')
    ...
    $('.js-example-basic-multiple').select2();
      ...
      <div style="background-color: #FFEC8B;" class="modal fade vertical-align-center" data-backdrop="false" id="medicalTeamModal" tabindex="-1" role="dialog" aria-labelledby="modalRequestLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalRequestLabel">Apply As An Emergency Medical Rescuer</h5>
      ...
      <form method="POST" action="{{route('storeMedicalRescue')}}"   enctype="multipart/form-data">
                      {{csrf_field()}}
