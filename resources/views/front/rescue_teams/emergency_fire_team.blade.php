...
<head>
    ...
    <title>ResQ 24/7 | Fire Rescue Team Sign Up</title>
...
@include('layouts.header')
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="text-center">
                        ...
                        <h2 style="font-size: 70px; color: gold;"><strong>BECOME A FIRE RESCUER</strong></h2>
                        <p>Earn cash and help people near you by responding to fire emergencies as requests come along.</p>
                         <div class="info_button">
                           <a class="boxed-btn3-white" title="Sign Up As A Rescuer" data-toggle="modal" data-target="#fireTeamModal"  href="">Sign Up As A Rescuer <i class="fa fa-hand-pointer-o"></i></a> 
                        </div>
                    </div>
                </div>
            </div>
  ...
  <ol class="breadcrumb">
    ...
    @endif
    <li class="breadcrumb-item active" aria-current="page">Fire Rescue Team </li>
  </ol>
</nav>
           <div  class="row">
                ...
                <div style=" background-color: #FFD700;" class="col-md-4 ">
                  <div class="text-center"> 
                    ...
                    <br><br>
                    <h2 style="color: #fff;"><strong>TURN PASSION TO A JOB</strong></h2>
                  </div>
                    <p style="color: #fff; font-size: 20px;"><i style="color: #4169E1;" class="fa fa-circle"></i> Are you a fresh graduate having completed your course in conflict resolution and humanitarian assistance or Disaster management? Can you work in a tough environment? Do you have passion in managing disasters around you to make your society safe?  Can you work with minimal or no supervision?  </p> 
                     <p style="color: #fff; font-size: 20px;"><i style="color: #4169E1;" class="fa fa-circle"></i> This is a great opportunity for you, <a style="color: blue;" href="" data-toggle="modal" data-target="#fireTeamModal">Join our community</a> and work from wherever you are to make our community safer, an opportunity to advance your skills in your area of profession and get rewarded for great work.</p> 
                ...
                <div  style="background-color: #4169E1; " class="col-md-4">
                  <div class="text-center"> 
                   ...
                   <p style="color: #fff; font-size: 20px;"><i style="color: #fff;" class="fa fa-circle"></i> Join the larger family of on demand paramedic service providers across the country. Nothing is fulfilling as having a life saved through your efforts, <a style="color: #FFD700;" href="" data-toggle="modal" data-target="#fireTeamModal">get started</a> today.</p>
...
<div class="container">
    ...
    <div class="card">
        ...
        <div id="signA" class="collapse show" aria-labelledby="signapp" data-parent="#accordion">
          <div class="card-body">
         This is our first line of engagement, its part of knowing our team remember to upload CV and details.
          </div>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
              <div class="info_button">
              <a class="boxed-btn3-login" title="Sign Up As A Rescuer" data-toggle="modal" data-target="#fireTeamModal"  href="">Sign Up As A Rescuer <i class="fa fa-hand-pointer-o"></i></a> 
            </div>
        </div>
        </div>
    </div>
...
@include('layouts.selects')
    ...
    $('.js-example-basic-multiple').select2();
      ...
      <div style="background-color: #FFEC8B;" class="modal fade vertical-align-center" data-backdrop="false" id="fireTeamModal" tabindex="-1" role="dialog" aria-labelledby="modalRequestLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalRequestLabel">Apply As An Emergency Fire Rescuer</h5>
      ...
      <form method="POST" action="{{route('storeFireRescue')}}"   enctype="multipart/form-data">
                      {{csrf_field()}}
