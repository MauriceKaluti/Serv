                         ...
                         @endif
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input required="" type="text" name="title" class="form-control" placeholder="Enter Event Title" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input required="" type="text" name="location" class="form-control" placeholder="Enter Event Location" />
                                        </div>
                                    </div>

                                           <div class="form-group">
                                        <div class="form-line">
                                            <input required="" type="text" name="map" class="form-control" placeholder="Enter Event Map Location URL" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input required="" type="date" title="Event Date" class="form-control" name="date" placeholder="Event Date" />
                                        </div>
                                    </div>

                                        <div class="form-group">
                                        <div class="form-line">
                                        	<input required="" type="file" name="image" class="form-control" title="Add Event Location Image">
                                        </div>
                                    </div>
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    ResQ 247 Events
                    <small>Explore All ResQ 247 Events</a></small>
                </h2>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <strong>Oh snap! Event Deleted Successfully.</strong>  </div>
                         @endif
                        </div>
                        ...
                        <div class="body">
                            ...
                            @forelse($showevents as $showevent)
                                        ...
                                        <tr>
                                            <td>{{$showevent->id}}  </td>
                                            <td> {{$showevent->title}}</td>
                                            <td>{{$showevent->date}} </td>
                                          
                                            <td>{{$showevent->created_at}} </td>
                                            <td>{{$showevent->updated_at}} </td>
                                                                                    
 
                         
                                             <td>
                                                <form action="{{route('deleteEvent',$showevent->id)}}" method="post">
                                                    {{csrf_field()}}
                                               <button style="border-style: none;"  type="submit"  title="Delete Event Forever"> <i style="color: red;" class="fa fa-trash"></i>

                                                </a>&nbsp&nbsp
                                            </form>
                                             	<a href="{{url('/admin_area/add_event_images/'.$showevent->id)}}" title="Upload Partner Images"><i class="fa fa-upload"></i></a>
                                             </td>
