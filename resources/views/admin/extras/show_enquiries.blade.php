...
<head>
    ...
    <title>ResQ 247 | Client Enquiries </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Client Enquiries
                    <small>Explore All ResQ 247 Client Enquiries</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Enquiry Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                        ...
                        <td>{{$enquiry->created_at}}</td>         
                         ...
                         <td>
                            <form action="{{route('deleteEnquiry',$enquiry->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Enquiry Forever"> <i style="color: red;" class="fa fa-trash"></i>
