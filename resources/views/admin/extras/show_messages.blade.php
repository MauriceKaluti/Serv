...
<head>
    ...
    <title>ResQ 247 | Contact Quick Messages </title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    ...
                    <small>Explore All ResQ 247 Contact Quick Messages</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Message Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                        ...
                        <td>{{$message->created_at}}</td>         
                         ...
                         <td>
                            <form action="{{route('deleteMessage',$message->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Message Forever"> <i style="color: red;" class="fa fa-trash"></i>

                            </button>&nbsp&nbsp
                         	<!-- <a title="Mark as Read" href="#" title="See More Details"><i class="fa fa-envelope"></i> </a> -->
                         </form>
                         </td>
                        </tr>
