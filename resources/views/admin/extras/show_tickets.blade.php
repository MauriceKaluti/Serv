...
<head>
    ...
    <title>ResQ 247 | Booked Event Tickets </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Booked Event Tickets
                    <small>Explore All ResQ 247 Booked Event Tickets</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Ticket Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                        ...
                        <div class="body">
                            ...
                            @forelse($tickets as $ticket)
                                        ...
                                        <tr>
                                            <td>{{$ticket->id}}</td>
                                            <td>{{$ticket->event_entity}}</td>
                                            <td>{{$ticket->event_title}}</td>
                                            <td>{{$ticket->applicant_name}}</td>                                          
                                            <td>{{$ticket->applicant_email}}</td>
                                            <td>{{$ticket->applicant_entity}}</td>
                                            <td>{{$ticket->applicant_department}}</td>
                                            <!-- <td>{{$ticket->applicant_position}}</td> -->
                                            <td>{{$ticket->ticket_price}}</td>
                                            <td>{{$ticket->created_at}}</td>         
                   
                                             <td>
                                                <form action="{{route('deleteEventTicket',$ticket->id)}}" method="post">
                                                    {{csrf_field()}}
                                                 <button style="border-style: none;"  type="submit"  title="Delete Event Ticket Forever"> <i style="color: red;" class="fa fa-trash"></i>

                                                </button>&nbsp&nbsp
                                             	<!-- <a href="#" title="See More Details"><i class="fa fa-eye"></i> </a> -->
                                             </form>
                                             </td>
                                        </tr>
