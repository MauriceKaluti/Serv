...
<head>
    ...
    <title>ResQ 247 | Fire Rescue Team Applicants </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    All Fire Rescue Team Applicants
                    <small>Explore All ResQ 247 Fire Rescue Team Applicants</a></small>
                </h2>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- End Notification -->
                     ...
                     @forelse($resFires as $resFire)
                        <tr>
                        <td>{{$resFire->id}}</td>
                        <td>{{$resFire->first_name}}</td>
                        <td>{{$resFire->company_name}}</td>
                        <td>{{$resFire->email}}</td>
                        <td>{{$resFire->vehicle_reg}}</td>
                        <td>{{$resFire->vehicle_model}}</td>                      
                        <td> <img title="Vehicle Photo" style="width: 100px; height: 100px;" src="{{url('images/teamimages/medium',$resFire->vehicle_photo)}}" alt=""> </td>
                        <td> <img title="Vehicle Photo" style="width: 100px; height: 100px;" src="{{url('images/teamimages/medium',$resFire->passport_photo)}}" alt=""> </td>                                           
                                                                           
                        <td>{{$resFire->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteRescueFire',$resFire->id)}}" method="post">
                                {{csrf_field()}}
