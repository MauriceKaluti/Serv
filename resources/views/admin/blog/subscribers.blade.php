...
<head>
    ...
    <title>ResQ 247 | Blog News Subscribers </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Blog News Subscribers
                    <small>Explore All ResQ 247 Blog News Subscribers</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Blog News Subscriber Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($subscribers as $subscriber)
                        ...
                        <td>
                            <form action="{{route('deleteSubscriber',$subscriber->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Subscriber Forever"> <i style="color: red;" class="fa fa-trash"></i>
                            </button>&nbsp&nbsp
                         </form>
                         </td>
                        </tr>
