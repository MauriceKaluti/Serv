...
<head>
    ...
    <title>ResQ 247 | Dharura Silver Subscriptions </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Dharura Silver Subscriptions
                    <small>Explore All ResQ 247 Dharura Silver Subscriptions</a></small>
                </h2>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- End Notification -->
                     ...
                     @forelse($dharuraSilvers as $dharuraSilver)
                        <tr>
                        <td>{{$dharuraSilver->id}}</td>
                        <td>{{$dharuraSilver->dharura_package}}</td>
                        <td>{{$dharuraSilver->name}}</td>
                        <td>{{$dharuraSilver->email}}</td>
                        <td>{{$dharuraSilver->phone}}</td>                                          
                        <td>{{$dharuraSilver->reg_no}}</td>                                          
                        <td>{{$dharuraSilver->vehicle_model}}</td>                                          
                        <td>{{$dharuraSilver->vehicle_type}}</td>
                        <td>{{$dharuraSilver->package_price}}</td>                                         
                        <td>{{$dharuraSilver->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteDharura',$dharuraSilver->id)}}" method="post">
                                {{csrf_field()}}
