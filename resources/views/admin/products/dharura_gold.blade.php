...
<head>
    ...
    <title>ResQ 247 | Dharura Gold Subscriptions </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Dharura Gold Subscriptions
                    <small>Explore All ResQ 247 Dharura Gold Subscriptions</a></small>
                </h2>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- End Notification -->
                     ...
                     @forelse($dharuraGolds as $dharuraGold)
                        <tr>
                        <td>{{$dharuraGold->id}}</td>
                        <td>{{$dharuraGold->dharura_package}}</td>
                        <td>{{$dharuraGold->name}}</td>
                        <td>{{$dharuraGold->email}}</td>
                        <td>{{$dharuraGold->phone}}</td>                                          
                        <td>{{$dharuraGold->reg_no}}</td>                                                                         
                        <td>{{$dharuraGold->vehicle_model}}</td>
                        <td>{{$dharuraGold->vehicle_type}}</td>
                        <td>{{$dharuraGold->package_price}}</td>                                         
                        <td>{{$dharuraGold->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteDharura',$dharuraGold->id)}}" method="post">
                                {{csrf_field()}}
