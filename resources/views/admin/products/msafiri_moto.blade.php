...
<head>
    ...
    <title>ResQ 247 | Msafiri Private Motorists Subscriptions </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Msafiri Private Motorists Subscriptions
                    <small>Explore All ResQ 247 Msafiri Private Motorists Subscriptions</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Msafiri Private Motorists Subscription Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($msafmotos as $msafmoto)
                        <tr>
                        <td>{{$msafmoto->id}}</td>
                        <td>{{$msafmoto->driver_name}}</td>
                        <td>{{$msafmoto->departure_location}}</td>
                        <td>{{$msafmoto->arrival_time}}</td>
                        <td>{{$msafmoto->vehicle_reg}}</td>                                          
                        <td>{{$msafmoto->moto_price}}</td>                                                        
                        <td>{{$msafmoto->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteMsafiriMoto',$msafmoto->id)}}" method="post">
                                {{csrf_field()}}
