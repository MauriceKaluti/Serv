...
<head>
    ...
    <title>ResQ 247 | Dharura Bronze Subscriptions </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Dharura Bronze Subscriptions
                    <small>Explore All ResQ 247 Dharura Bronze Subscriptions</a></small>
                </h2>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- End Notification -->
                     ...
                     @forelse($dharuraBronzes as $dharuraBronze)
                        <tr>
                        <td>{{$dharuraBronze->id}}</td>
                        <td>{{$dharuraBronze->dharura_package}}</td>
                        <td>{{$dharuraBronze->name}}</td>
                        <td>{{$dharuraBronze->email}}</td>
                        <td>{{$dharuraBronze->phone}}</td>                                          
                        <td>{{$dharuraBronze->reg_no}}</td>                                          
                        <td>{{$dharuraBronze->vehicle_model}}</td>
                        <td>{{$dharuraBronze->vehicle_type}}</td>
                        <td>{{$dharuraBronze->package_price}}</td>                                         
                        <td>{{$dharuraBronze->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteDharura',$dharuraBronze->id)}}" method="post">
                                {{csrf_field()}}
