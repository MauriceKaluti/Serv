...
<head>
    ...
    <title>ResQ 247 | Dharura Platinum Subscriptions </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Dharura Platinum Subscriptions
                    <small>Explore All ResQ 247 Dharura Platinum Subscriptions</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Dharura Subscription Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($dharuraPlatinums as $dharuraPlatinum)
                        <tr>
                        <td>{{$dharuraPlatinum->id}}</td>
                        <td>{{$dharuraPlatinum->dharura_package}}</td>
                        <td>{{$dharuraPlatinum->name}}</td>
                        <td>{{$dharuraPlatinum->email}}</td>
                        <td>{{$dharuraPlatinum->phone}}</td>                                          
                        <td>{{$dharuraPlatinum->reg_no}}</td>                                          
                        <td>{{$dharuraPlatinum->vehicle_model}}</td>                                          
                        <td>{{$dharuraPlatinum->vehicle_type}}</td>
                        <td>{{$dharuraPlatinum->package_price}}</td>                                         
                        <td>{{$dharuraPlatinum->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteDharura',$dharuraPlatinum->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Dharura Subscription Forever"> <i style="color: red;" class="fa fa-trash"></i>
