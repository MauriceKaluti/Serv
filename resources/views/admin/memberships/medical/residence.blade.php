...
<head>
    ...
    <title>ResQ 247 | Residence Emergency Medical Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Residence Emergency Medical Applications
                    <small>Explore All ResQ 247 Residence Emergency Medical Applications</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Residence Emergency Medical Application Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($resDs as $resD)
                        ...
                        <td>{{$resD->contact_person}}</td>               
                        <td>{{$resD->duration_cover}}</td>               
                        <td>{{$resD->medical_condition}}</td>               
                        <td>{{$resD->emergency_med_res_price}}</td>                                         
                        <td>{{$resD->created_at}}</td>         

                         <td>
                            <form action="{{route('deletemedicalResidence',$resD->id)}}" method="post">
                                {{csrf_field()}}
