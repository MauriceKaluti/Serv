...
<head>
    ...
    <title>ResQ 247 | Corporate Emergency Medical Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Corporate Emergency Medical Applications
                    <small>Explore All ResQ 247 Corporate Emergency Medical Applications</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Corporate Emergency Medical Application Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($corps as $corp)
                        <tr>
                        <td>{{$corp->id}}</td>
                        <td>{{$corp->company_name}}</td>                     
                        <td>{{$corp->email}}</td>                     
                        <td>{{$corp->phone_one}}</td>                       
                        <td>{{$corp->industry}}</td> 
                        <td>{{$corp->no_employees}}</td>                        
                        <td>{{$corp->emergency_med_corp_price}}</td>                                         
