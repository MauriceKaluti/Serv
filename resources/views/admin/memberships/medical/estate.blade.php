...
<head>
    ...
    <title>ResQ 247 | Estate Emergency Medical Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Estate Emergency Medical Applications
                    <small>Explore All ResQ 247 Estate Emergency Medical Applications</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Estate Emergency Medical Application Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($estates as $estate)
                        <tr>
                        <td>{{$estate->id}}</td>
                        <td>{{$estate->est_name}}</td>                     
                        <td>{{$estate->phone_one}}</td>                     
                        <td>{{$estate->email}}</td>                     
                        <td>{{$estate->contact_person}}</td>                      
                        <td>{{$estate->no_households}}</td>                 
                        <td>{{$estate->emergency_med_estate_price}}</td>                                         
                        <td>{{$estate->created_at}}</td>         

                         <td>
                            <form action="{{route('deletemedicalEstate',$estate->id)}}" method="post">
                                {{csrf_field()}}
