...
<head>
    ...
    <title>ResQ 247 | Family Emergency Medical Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Family Emergency Medical Applicationss
                    <small>Explore All ResQ 247 Family Emergency Medical Applicationss</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Family Emergency Medical Applications Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($familys as $family)
                        ...
                        <td>{{$family->email}}</td>                     
                        <td>{{$family->phone_one}}</td> 
                        <td>{{$family->idp_no}}</td>                       
                        <td>{{$family->dob}}</td> 
                        <td>{{$family->med_info}}</td> 
                        <td>{{$family->no_dependants}}</td>                        
                        <td>{{$family->emergency_med_fam_price}}</td>                                         
                        <td>{{$family->created_at}}</td>         

                         <td>
                            <form action="{{route('deletemedicalFamily',$family->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Family Application Forever"> <i style="color: red;" class="fa fa-trash"></i>
                            </button>&nbsp&nbsp
