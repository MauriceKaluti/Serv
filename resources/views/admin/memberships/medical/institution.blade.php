...
<head>
    ...
    <title>ResQ 247 | Institution Emergency Medical Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Institution Emergency Medical Applications
                    <small>Explore All ResQ 247 Institution Emergency Medical Applications</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Institution Emergency Medical Application Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($insts as $inst)
                        ...
                        <td>{{$inst->no_students}}</td>           
                        <td>{{$inst->emergency_med_inst_price}}</td>                                         
                        <td>{{$inst->created_at}}</td>         

                         <td>
                            <form action="{{route('deletemedicalInstitution',$inst->id)}}" method="post">
                                {{csrf_field()}}
