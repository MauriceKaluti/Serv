...
<head>
    ...
    <title>ResQ 247 | Truck Emergency Road Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Truck Emergency Road Applications
                    <small>Explore All ResQ 247 Truck Emergency Road Applications</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! Truck Emergency Road Application Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($trucks as $truck)
                        ...
                        <td>{{$truck->town}}</td> 
                        <td>{{$truck->road_price}}</td>                                         
                        <td>{{$truck->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteroadTruck',$truck->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Truck Application Forever"> <i style="color: red;" class="fa fa-trash"></i>
