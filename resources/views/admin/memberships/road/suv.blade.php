...
<head>
    ...
    <title>ResQ 247 | SUV Emergency Road Applications </title>
    <!-- Favicon-->
      ...
      <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    SUV Emergency Road Applications
                    <small>Explore All ResQ 247 SUV Emergency Road Applications</a></small>
                </h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                      ...
                      <!-- Notification -->
                        ...
                        <strong>Oh Snap! SUV Emergency Road Application Deleted Successfully!</strong>  </div>
                         @endif
                    <!-- End Notification -->
                     ...
                     @forelse($suvs as $suv)
                        <tr>
                        <td>{{$suv->id}}</td>
                        <td>{{$suv->owner_name}}</td>                     
                        <td>{{$suv->email}}</td> 
                        <td>{{$suv->phone}}</td> 
                        <td>{{$suv->vehicle_model}}</td> 
                        <td>{{$suv->town}}</td> 
                        <td>{{$suv->road_price}}</td>                                         
                        <td>{{$suv->created_at}}</td>         

                         <td>
                            <form action="{{route('deleteroadSuv',$suv->id)}}" method="post">
                                {{csrf_field()}}
                             <button style="border-style: none;"  type="submit"  title="Delete Suv Application Forever"> <i style="color: red;" class="fa fa-trash"></i>
