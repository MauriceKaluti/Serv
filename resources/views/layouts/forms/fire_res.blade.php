 <form class="form-contact form form-emergency_fire_residence" action="{{route('storeFirePackage')}}" method="post">
                      {{csrf_field()}}
  <input class="form-control valid" value="@if (Auth::guest()) @else {{Auth::user()->id}} @endif" name="user_id" hidden="" type="text"  placeholder="Applicant User ID">
                <input class="form-control valid" value="Residence" name="package_type" hidden="" type="text"  placeholder="Package Type">

                 <div class="popup_boxPage ">
                 <div class="popup_inner">
                <h3>Individual Private Residence</h3>
                            <div class="row">
                                ...
                                <div style="margin-bottom: 30px;" class="col-sm-6">
                                    <div class="form-group">
            <select style="display:block; width:100%;padding:0;border-width:0" required="" id="rescounty" multiple="" name="county[]"></select>
 ...
 <div style="margin-bottom: 30px;" class="col-sm-6">
                               <div class="form-group">
                               <select style="display:block; width:100%;padding:0;border-width:0" required="" id="resfire_serv_category" multiple="" name="serv_category"></select>
