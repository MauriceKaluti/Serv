             ...
             <form class="form-contact form form-emergency_fire_hotel" action="{{route('storeFirePackage')}}" method="post">
                      {{csrf_field()}}
                ...
                <input class="form-control valid" value="Hotel" name="package_type" hidden="" type="text"  placeholder="Package Type">

             <div class="popup_boxPage">
            <div class="popup_inner">

                <h3>Subscribe For Hotel</h3>
                            <div class="row">
                                ...
                                <div style="margin-bottom: 30px;" class="col-sm-6">
                                    <div class="form-group">
                                    <select style="display:block; width:100%;padding:0;border-width:0" required="" id="hotcounty" multiple="" name="county[]"></select>
                                      ...
                                      <div style="margin-bottom: 30px;" class="col-sm-6">
                                    <div class="form-group">
                                    <select style="display:block; width:100%;padding:0;border-width:0" required="" id="hottown" multiple="" name="town[]"></select>                                    
                                    </div>
                                </div>
                                      ...
                                      <div style="margin-bottom: 30px;" class="col-sm-6">
                                    <div class="form-group">
                                <select style="display:block; width:100%;padding:0;border-width:0" required="" id="hotfire_serv_category" multiple="" name="serv_category[]"></select>
                                    </div>
                                </div>
                               ...
                               <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input required="" readonly="" value="6500" class="form-control valid" name="cost"  type="text" placeholder="Price">
                                    </div>
                                </div> 
