               <form class="form-contact form form-emergency_fire_corporate" action="{{route('storeFirePackage')}}" method="post">
                      {{csrf_field()}}
                ...
                <input class="form-control valid" value="Corporate" name="package_type" hidden="" type="text"  placeholder="Package Type">
            <div class="popup_boxPage ">
            <div class="popup_inner">
                <h3>Subscribe For Corporate</h3>
            <div class="row">
           ...
           <div style="margin-bottom: 30px;" class="col-sm-6">
                             ...
                             <select style="display:block; width:100%;padding:0;border-width:0" required="" id="fire_serv_category" multiple="" name="serv_category[]"></select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required="" readonly="" value="8500" class="form-control valid" name="cost"  type="text" placeholder="Price">
                                    </div>
                                </div> 
            ...
            <div class="form-group mt-3">
                <button type="submit" class="boxed-btn3-login">Apply Now</button>
            </div>
            </div>
            </div>
       </form>