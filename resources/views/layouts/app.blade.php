...
<head>
    ...
    <title>{{ config('app.name', 'ResQ247') }}</title>
            ...
            <!--     <a class="navbar-brand" href="{{ url('/') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="boxed-btn3-login" href="{{ route('login') }}"><i class="fa fa-key"></i> {{ __('Login') }}</a>
                            </li>&nbsp&nbsp&nbsp
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="boxed-btn3-login" href="{{ route('register') }}"><i class="fa fa-book"></i> {{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
